        ...
        <main className="bg-primary font-outfit">
            <div className="flex gap-8 justify-around max-md:p-10 px-32 py-16 border-t-2 border-secondary border-opacity-20 max-md:gap-2">
                ...
                <div className=" flex flex-col gap-6 max-md:gap-2">
                    ...
                    <a href="https://www.instagram.com/flourishmgt/" className="text-lg text-secondary text-opacity-50 hover:underline hover:text-complementary max-md:text-sm">Instagram</a>
                </div>
                <div className=" flex flex-col gap-6 max-md:gap-2">
                ...
                <div className=" flex flex-col gap-8 max-md:gap-2">
                    ...
                    <h3 className="text-lg max-md:text-sm text-secondary text-opacity-50">© 2024 Flourish Management. All Rights Reserved</h3>
                    <h3 className="text-lg max-md:text-sm text-secondary text-opacity-50">Designed by <a href="" className="underline hover:text-complementary text-secondary ">Kaan</a></h3>
                </div>
            </div>
        </main>
    )
